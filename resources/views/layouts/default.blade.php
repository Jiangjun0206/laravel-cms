                    ...
                    <li class="pull-right">
                        <ul class="list-inline icon-position">
                            <li>
                                ...
                                <label class="hidden-xs"><a href="mailto:" class="text-white">dzheng764@gmail.com</a></label>
                            </li>
                            <li>
                                <a href="tel:"><i class="livicon" data-name="phone" data-size="18" data-loop="true" data-c="#fff" data-hc="#fff"></i></a>
                                <label class="hidden-xs"><a href="tel:" class="text-white">(+86) 17157388698</a></label>
                            </li>
                        </ul>
                    </li>
                </ul>
