...
<div class="container">
    ...
    width: 40%"><img src="{{ asset('assets/images/parallax/login_companyLogo.png')}}"></div>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">LEGAL INSURANCE</h3>
                    <h4 style="color:red; text-align:center">tutela a resarcemento</h4>
                </div>
                <div class="panel-body">
                    <form action="{{ route('signin') }}" id="authentication" autocomplete="on" method="post" role="form">
                        ...
                        <div class="form-group {{ $errors->first('email', 'has-error') }}">
                            <input class="form-control" placeholder="Nome Utente" name="email" type="text"
                                   value="{!! old('email') !!}"/>
                    ...
                    <input type="submit" value="AUTENTICATI" class="btn btn-danger btn-block btn-lg" />
                    </form>
                </div>
            </div>
        </div>
